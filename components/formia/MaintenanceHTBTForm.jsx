...
export function MaintenanceHTBTForm({ entity, agency, documentType, initialData, draftId, onBack }) {
  ...
  const getInitialFormData = () => {
    ...
    controlesAccessoires: TABLEAUX_CONTROLES.accessoiresSecurite.controles.map((c) => ({ label: c.label, vu: false, observations: '' })),
    controlesDisjoncteurBT: TABLEAUX_CONTROLES.disjoncteurBT.controles.map((c) => ({ label: c.label, vu: false, observations: '' })),
    controlesCellulesHTA: TABLEAUX_CONTROLES.cellulesHTA.controles.map((c) => ({ label: c.label, vu: false, observations: '' })),
    controlesTransformateur: TABLEAUX_CONTROLES.transformateur.controles.map((c) => ({ label: c.label, vu: false, observations: '' })),
    controlesLocalPoste: TABLEAUX_CONTROLES.localPoste.controles.map((c) => ({ label: c.label, vu: false, observations: '' })),
    photosApres: [],
